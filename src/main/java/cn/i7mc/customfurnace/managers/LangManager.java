...
public class LangManager {
     ...
     */
    public void reload() {
        // 直接重新加载消息配置，而不是调用ConfigManager的reloadConfigs
        messagesConfig = YamlConfiguration.loadConfiguration(configManager.getMessagesFile());
        debugMessagesConfig = YamlConfiguration.loadConfiguration(configManager.getDebugMessagesFile());
    }
} 